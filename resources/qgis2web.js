...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7545336.924087, -1832329.770191, -7533374.181964, -1825825.353508], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-7545336.924087, -1832329.770191, -7533374.181964, -1825825.353508], map.getSize());
...
//           <h1 class="title-large">COMUNIDAD LACAHUARCA LAS UNIDAS</h1>
//            <p class="title-medium">COMPARATIVA DE IMAGENES - CLASIFICACIÓN SUPERVISADA</p>
